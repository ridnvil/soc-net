...
class _UploadState extends State<Upload> with AutomaticKeepAliveClientMixin<Upload> {
      ...
      builder: (context){
        return SimpleDialog(
          ...
          children: <Widget>[
            ...
            SimpleDialogOption(
              child: Text("Images from Galery"),
              onPressed: handleChooseFromGalerry,
            ),
            SimpleDialogOption(
              child: Text("Cancel"),
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: RaisedButton(
              ...
              color: Colors.blue,
              onPressed: () => selectImages(context),
            ),
          )
        ],
      ),
  ...
  compressImage() async {
    ...
    final compressImageFile = File('$path/img_$postId.jpg')..writeAsBytesSync(Im.encodeJpg(imageFile, quality: 80));
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          Divider(),
          ListTile(
            leading: Icon(Icons.pin_drop, color: Colors.deepPurple, size: 35.0,),
            title: Container(
              width: 250.0,
              child: TextField(
