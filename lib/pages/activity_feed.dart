...
class ActivityFeedItem extends StatelessWidget {
  ...
  configureMediaPreview(context) {
    ...
    if(type == 'like'){
      activityItemsText = "liked your post";
    }else if(type == 'follow'){
      activityItemsText = "is following you";
    }else if(type == 'comment'){
      activityItemsText = "replied: $commentData";
    }else{
      activityItemsText = "Error: Unknown type '$type'";
    }
  }
